...
fn is_bad_perm_range(offset: usize, length: usize, max_q_power: usize) -> bool {
    offset + length > max_q_power
}

fn bi_compare(a: usize, b: usize) -> Ordering {
    a.cmp(&b)
}
...
fn rand() -> f64 {
    // TODO: Implement the rand function
    0.0
}

fn dump() {
    // TODO: Implement the dump function
}
